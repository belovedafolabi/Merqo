    ...
    <Button asChild variant="outline" size="icon" aria-label={label} className="relative">
      <Link href="/notifications">
        ...
        {unreadCount > 0 && (
          <span
            aria-hidden="true"
            className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-destructive px-1 text-[10px] font-semibold leading-none text-white"
          >
